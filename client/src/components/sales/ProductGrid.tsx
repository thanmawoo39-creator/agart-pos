...
export function ProductGrid({
  ...
  const handleAddToCart = useCallback((product: Product, event: React.MouseEvent<HTMLElement>) => {
    ...
    // Get cart icon position (fallback to top-right if ref not provided)
  ...
  return (
    <>
      {/* CSS for fly animation and touch optimizations */}
      <style>{`
        @keyframes flyToCart {
          0% {
        ...
        /* Disable tap highlights for mobile */
        * {
