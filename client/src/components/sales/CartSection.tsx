              ...
              <div className="space-y-3">
                ...
                {paymentMethod === 'mobile' && (
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      ...
                      {slipVerification && (
                        <div className={`p-3 rounded-lg flex items-center gap-2 ${slipVerification.verified
                ...
                {isRestaurantMode && selectedTable?.id ? (
                  <div className="grid grid-cols-2 gap-2">
                    <Button
                      onClick={onOrder}
                      disabled={orderPending || calculateTotal() <= 0 || !hasOpenShift()}
                      className="h-12 bg-primary text-primary-foreground hover:bg-primary/90 font-semibold"
                    >
                      {orderPending ? 'Ordering...' : 'Order'}
                    </Button>
                    <Button
                      variant="outline"
                      onClick={onCheckBill}
                      disabled={checkBillPending || !selectedTable?.currentOrder || !hasOpenShift()}
                      className="h-12"
                    >
                      {checkBillPending ? 'Checking...' : 'Check Bill'}
                    </Button>
                  </div>
                ) : null}
                ...
                <Button
                  ...
                  disabled={
                    ...
                    calculateTotal() <= 0 ||
                    !hasOpenShift() ||
                    (isRestaurantMode && selectedTable?.id && selectedTable?.serviceStatus !== 'billing')
                  }
                  className="w-full h-12"
                >
                  Quick Pay (Cash)
